...
def genesis():
    ...
    solns = [MIP_soln1, MIP_soln2, Greedy_soln1, Greedy_soln2]
...
def evolutionPlus():
    ...
    np.save("GA_soln_improved_progress_2023.npy", solns)
    ...
    return best_soln, gen_count

best_soln, num_gen = evolutionPlus()
print(best_soln)

np.save('GA_soln_improved_2023.npy', [best_soln, num_gen])
...
with open("GA_output_raw_improved_2023.txt", "w") as file:
    sys.stdout = file
    print(best_soln)  # This will be written to output.txt

with open("GA_output_interpreted_improved_2023.txt", "w") as file:
    sys.stdout = file 
