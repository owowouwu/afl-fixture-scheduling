...
# wins = [11,17,13.5,18,11,10,10.5,9,13,7,16,3,17,10.5,13,12.5,3,12] # 2023 pre-finals wins
...
def genesis():
    ...
    MIP_soln2 = np.load('initialPopulation/MILP_Fixture_1000000_2023.npy')
    Greedy_soln1 = np.load('initialPopulation/2023-greedy1-1.npy')
    Greedy_soln2 = np.load('initialPopulation/2023-greedy1-2.npy')
    MIP_solns = [MIP_soln1, MIP_soln2, Greedy_soln1, Greedy_soln2]
    
    # Initial Solution 2022
    # MIP_soln1 = np.load('initialPopulation/MILP_Fixture_1000_2022.npy')
    # MIP_soln2 = np.load('initialPopulation/MILP_Fixture_100_2022.npy')
    # Greedy_soln1 = np.load('initialPopulation/2022-greedy1-1.npy')
    # Greedy_soln2 = np.load('initialPopulation/2022-greedy1-2.npy')
...
def evolutionPlus():
    ...
    np.save("GA_soln_progress_base_2023.npy", solns)
...
print(best_soln)
np.save('GA_soln_base_2023.npy', [best_soln, num_gen])
...
with open("output/GA_greedy_output_raw_2023_base.txt", "w") as file:
    sys.stdout = file
    print(best_soln)  # This will be written to output.txt

with open("output/GA_greedy_output_interpreted_2023_base.txt", "w") as file:
    sys.stdout = file 
